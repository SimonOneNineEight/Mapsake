...
- [ ] **Task 2 — zh-Hant label gazetteer (AC: 2)**
...
- Context engine analysis completed — Story 1.2 (tile pipeline) split from original 1.2 per the readiness report; render is the separate Story 1.3.
